    ...
    >
      <div className="flex items-center justify-between px-6 py-1 md:px-12">
        <Link to="/" className="flex items-center gap-3">
          <img src="/logo/logo.png" alt="Real Dreams Enterprises Limited logo" className="h-20 md:h-24 w-auto object-contain dark:hidden" />
          <img src="/logo/logo-dark-mode.png" alt="Real Dreams Enterprises Limited logo" className="h-20 md:h-24 w-auto object-contain hidden dark:block" />
